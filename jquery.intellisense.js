(function($){
	...
	$.fn.Autosuggest = function(options)
	{
		...
		function Autosuggest($me)
		{
			var AS = $.extend(DEFAULTS,options)
			
			if(AS.debug) console.log({ 'AS' : AS, 'this':this })
			...
			{	
				var allTokens = getAllTokens(), indexOfToken = getIndexOfTokenAtPos( pos )
			...
			var filterSuggestions = function(q)
			{
				...
				{
					var suggestionObject = listOfSuggestions[s], suggestionDisplayName = ''
